...
function Feature() {
  return (
    <section className="text-gray-600 body-font bg-gray-100 py-24">
      <HeadingWithParagraph title={"All-in-One "} subtitle={" Cloud Software"}
       message={" TOTC in powerful online software suite that combines all the toolsneed to learn a succesful school or office."}/>
      <div className="flex lg:flex-row md:flex-row justify-between items-start mx-auto  flex-col w-[calc(100%-5%)] gap-6 -mb-10">
